...
SECRET_KEY = 'django-insecure-00mw1m@3mjv&(3@ff0a$nrp*5ji6i8yjqd569va=3k&j!m=3n0'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Require authentication for most views
    ],
}
# core/settings.py
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),  # Hoặc timedelta(hours=2), tùy bạn
